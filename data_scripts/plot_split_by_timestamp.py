...
# This plots data from the spectrometr JSON files.  They are split by the timestamps of peaks, given as a list, and
# the indices in the index_list are plotted on a graph.
...
graph_title = "\nMean Spectra Per Layer, for 'Print 2'"
x_label = "Wavelength / nm"
y_label = "Sample Mean Reading"
...
# List of layer indices to plot
index_list = [0, 52, 53, 54, 55, 100, 101, 102]

# Directory containing the spectrometer .JSON files.
...
# TODO Move these utility functions into a single file
def smooth_plot(df):
